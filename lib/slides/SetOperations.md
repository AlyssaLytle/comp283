...
>Haven't we seen this notation before? Are we overloading variables again??
...
Your next practice worksheet on counting is now on Gradescope! It's due next Wednesday.

Monday, we will be doing an in-class activity. It is an opportunity for extra credit!

**You can only play if you show up for class!** 

(If you are going to be absent, email me.)
